...
export function AuthProvider({ children }) {
  ...
  const value = useMemo(
    ...
    [loading, user, role, permissions, accountStatus, isAuthenticated, login, logout, register, verifyEmail, resendVerification, forgotPassword, resetPassword, checkPasswordStrength, hasPermission]
  );
