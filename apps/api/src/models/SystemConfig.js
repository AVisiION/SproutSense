...
const systemConfigSchema = new mongoose.Schema({
  ...
  uiPreferences: {
    ...
    sidebarVisibility: {
      ...
      esp32: { type: Boolean, default: true },
      settings: { type: Boolean, default: true },
    },
    widgets: {
      showAlertBadge: { type: Boolean, default: true },
      showStatusDots: { type: Boolean, default: true },
      showSystemStatusPanel: { type: Boolean, default: true },
    }
  },

  // Per-plant custom thresholds and watering limits configured by admin.
  plantSensorConfig: {
