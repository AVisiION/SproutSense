...
// POST /api/sensors/device - Create new sensor reading with device token auth
router.post('/device', sensorPostLimiter, validateSensorReading, authenticateDevice, createSensorReading);
